...
typedef void ops_decrypt_block_encrypt_t(ops_decrypt_t *decrypt,void *out,
					 const void *in);
...
struct _ops_decrypt_t
    ...
    ops_decrypt_init_t *base_init;
    ops_decrypt_resync_t *resync;
    //    ops_decrypt_decrypt_t *decrypt;
    ops_decrypt_block_encrypt_t *block_encrypt;
...
size_t ops_decrypt_decrypt(ops_decrypt_t *decrypt,void *out,const void *in,
			 size_t count);
